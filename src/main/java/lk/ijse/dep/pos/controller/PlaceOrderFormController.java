...
public class PlaceOrderFormController {
    ...
    public void btnPlaceOrder_OnAction(ActionEvent actionEvent) {
        ...
        try {
          orderBO.placeOrder(new OrderTM(lblId.getText(), Date.valueOf(LocalDate.now()) , cmbCustomerId.getValue().getId(), cmbCustomerId.getValue().getName(),0),tblOrderDetails.getItems());
